...
struct TutorialStepData {
    ...
    static let all: [TutorialStepData] = [
        ...
        .init(anchorId: "albaBlocks", titleEs: "Alba Blocks", titleEn: "Alba Blocks",
              messageEs: "Aquí encontrarás artículos cortos sobre amistades, límites sanos y bienestar emocional.",
        ...
        .init(anchorId: "albaIA", titleEs: "AlbaIA", titleEn: "AlbaAI",
              messageEs: "Plática conmigo y recibe consejos basados en psicología positiva.",
        ...
        .init(anchorId: "albaTest", titleEs: "Alba Test", titleEn: "Alba Test",
              messageEs: "Basado en psicología positiva, reflexiona si esa amistad realmente vale la pena.",
              messageEn: "Based on positive psychology, reflect on whether a friendship is truly worth it.",
              cornerRadius: 28, padding: 10),
        .init(anchorId: "settings", titleEs: "Configuración", titleEn: "Settings",
              messageEs: "Ajusta el idioma y escucha música mientras usas la app.",
        ...
        .init(anchorId: "", titleEs: "¡Lista!", titleEn: "Ready!",
              messageEs: "Estoy lista para ayudarte. Si te pierdes, siempre voy a estar aquí.",

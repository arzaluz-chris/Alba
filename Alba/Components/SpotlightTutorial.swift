...
struct TutorialStepData {
    ...
    static let all: [TutorialStepData] = [
        ...
        .init(anchorId: "albaTest", titleEs: "Alba Test", titleEn: "Alba Test",
              messageEs: "Basado en el modelo PERMA, reflexiona si esa amistad realmente vale la pena.",
              messageEn: "Based on the PERMA model, reflect on whether a friendship is truly worth it.",
              cornerRadius: 28, padding: 10),
